...
interface iRespond
{
	 ...
	 */
	public static function __formatResponse($result);
	/**
	 ...
	 */
	public static function __formatError($status_code, $message);
}
/**
...
class DefaultResponse implements iRespond {
	static function __formatResponse($result) {
		return $result;
	}
	static function __formatError($statusCode, $message) {
