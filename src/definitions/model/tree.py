class Tree(object):
    def __init__(self, id_, soe_id, name, tree_type, max_points, is_warder_tree, aa, subtrees, orphans, tree_category, x_y_ratio=0, x_subclass="", y_subclass=""):
        self.id = id_
        self.soe_id = soe_id
        self.name = name
        self.type = tree_type
